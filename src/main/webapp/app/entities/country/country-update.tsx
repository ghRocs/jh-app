  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="jhApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="countryNameLabel" for="country-countryName">
                  <Translate contentKey="jhApp.country.countryName">Country Name</Translate>
                </Label>
                <AvField id="country-countryName" data-cy="countryName" type="text" name="countryName" />
              </AvGroup>
              <AvGroup>
                <Label id="languageLabel" for="country-language">
                  <Translate contentKey="jhApp.country.language">Language</Translate>
                </Label>
                <AvInput
                  id="country-language"
                  data-cy="language"
                ...
                >
                  <option value="FRENCH">{translate('jhApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="country-region">
                  <Translate contentKey="jhApp.country.region">Region</Translate>
                </Label>
